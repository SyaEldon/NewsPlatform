...
<form action="/login" method="post">
    ...
    <option value ="1">新闻序号</option>
    <option value ="2">标题</option>
    <option value ="3">分区</option>
    <option value ="4">发布者</option>
    <option value ="5">发布时间</option>
</select><input type="submit" value="发布" name="searchSubmit"/></br>
</form>
    ...
    <table border="1px">
        ...
        <c:forEach items="${list}" var="item">
            <tr>
                ...
                <td>
                    <form id="delete_form" method="post" action="/administratorPage/delete">
                ...
                <td><a href="/">修改</a></td>
                <td>
                    <form id="updateVisible_form" method="post" action="/administratorPage/updateVisible">
